...
import { ApprovalState, useApproveTransaction } from 'hooks/useApproveTransaction'
...
export default function AddLiquidity({
  ...
  const [approvalA, approveATransaction] = useApproveTransaction(parsedAmounts[Field.CURRENCY_A], ROUTER_ADDRESS)
  const [approvalB, approveBTransaction] = useApproveTransaction(parsedAmounts[Field.CURRENCY_B], ROUTER_ADDRESS)
